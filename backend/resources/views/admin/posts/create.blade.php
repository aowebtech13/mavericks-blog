...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="rounded-xl border border-white/10 bg-night-800/60 p-4 md:p-8 space-y-6">
        ...
        <div>
            ...
            <textarea name="content" rows="10" class="rich-text w-full rounded-lg border border-white/10 bg-night-950 px-4 py-2.5 text-base text-white transition focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent" placeholder="Full post content">{{ old('content') }}</textarea>
